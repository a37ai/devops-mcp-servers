...
try:
    from servers.ansible_tower.ansible_tower_mcp import *
...
try:
    import servers.ansible_tower.ansible_tower_mcp as ansible_tower_mcp
    ansible_tower_mcp.handle_pagination = safe_handle_pagination
