...
class DatadogMCPServer:
    ...
    def register_tags_resources_and_tools(self):
        """Register resources and tools for Datadog Tags API"""
        # Implement this method to match what's expected in the tests
        pass
